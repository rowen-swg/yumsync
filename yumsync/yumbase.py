...
""" YumBase object specifically for yumsync.

This class is a simple extension of the yum.YumBase class. It is required
because yumsync uses YUM in an atypical way. When we load a YUM object, we want
...
class YumBase(yum.YumBase):
    ...
    def __init__(self):
        """ Create a new YumBase object for use in yumsync. """
